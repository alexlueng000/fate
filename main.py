...
def create_app() -> FastAPI:
    ...
    app.include_router(message_rating.router, prefix="/api", tags=["message-rating"])
    ...
    app.include_router(admin_products.router, prefix="/api", tags=["admin-products"])
    ...
    app.include_router(relationship_progress.router, prefix="/api", tags=["relationship-progress"])
